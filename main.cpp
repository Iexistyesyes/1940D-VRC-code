...
//  - you should get positive values on the encoderss going FORWARD and RIGHT
...
void initialize() {
  ...
  // chassis.odom_tracker_back_sset(&horiz_tracker);
  ...
  ez::as::auton_selector.autons_add({
      {"Drive\n\nDrive forward and come back", blueauton},
